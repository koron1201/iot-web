...
const ScheduleForm: React.FC<ScheduleFormProps> = ({
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 flex-grow overflow-y-auto px-1">
        {/* --- 入力フィールド --- */}
        ...
        {/* --- フッターエリア --- */}
        <div className="mt-auto pt-4 border-t flex flex-col gap-4 pb-2">
